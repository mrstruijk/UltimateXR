    ...
    public partial class UxrToggleControlInput : UxrControlInput
    {
        ...
        protected override void OnClicked(PointerEventData eventData)
        {
            ...
            if (Interactable)
            {
                ...
                var audioPosition = UxrAvatar.LocalAvatarCamera ? UxrAvatar.LocalAvatar.CameraPosition : transform.position;
        ...
        private void SetIsSelected(bool value)
        {
            ...
            foreach (var goToEnable in _enableWhenSelected)
            {
                if (goToEnable == null)
                {
            ...
            foreach (var goToEnable in _enableWhenNotSelected)
            {
                if (goToEnable == null)
                {
            ...
            foreach (var textEntry in _textColorChanges)
            {
