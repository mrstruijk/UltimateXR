...
namespace UltimateXR.Mechanics.Weapons
{
    ...
    public class UxrFirearmAmmoLabel : UxrComponent
    {
        ...
        private void UxrManager_AvatarsUpdated()
        {
            ...
            var ammoRemaining = _firearm.HasMagAttached(_triggerIndex) ? _firearm.GetAmmoLeft(_triggerIndex).ToString() : string.Empty;
            var ammoCapacity = _firearm.HasMagAttached(_triggerIndex) ? _firearm.GetAmmoCapacity(_triggerIndex).ToString() : string.Empty;
