...
namespace UltimateXR.Editor.Devices
{
    ...
    public class UxrController3DModelElementDrawer : PropertyDrawer
    {
        ...
        {
            var controller3DModel = property.serializedObject.targetObject as UxrController3DModel;
            var enumIndex = property.FindPropertyRelative(PropertyElementType).enumValueIndex;
            var lineCount = 1;
        ...
        private GUIContent ContentElementType { get; } = new("Type", "");
        private GUIContent ContentHand { get; } = new("Hand", "");
        private GUIContent ContentElement { get; } = new("Element", "");
        private GUIContent ContentGameObject { get; } = new("GameObject", "");
        private GUIContent ContentFinger { get; } = new("Finger Used", "");
        private GUIContent ContentFingerContactPoint { get; } = new("Finger Contact Pos", "");
        private GUIContent ContentButtonPressedOffset { get; } = new("Pressed Offset", "");
        private GUIContent ContentInput1DPressedOffsetAngle { get; } = new("Pressed Angle Offset", "");
        private GUIContent ContentInput1DPressedOffset { get; } = new("Pressed Offset", "");
        private GUIContent ContentInput2DFirstAxisOffsetAngle { get; } = new("1st Axis Angle Amplitude", "");
        private GUIContent ContentInput2DSecondAxisOffsetAngle { get; } = new("2nd Axis Angle Amplitude", "");
        private GUIContent ContentInput2DFirstAxisOffset { get; } = new("1st Axis Offset Amplitude", "");
        private GUIContent ContentInput2DSecondAxisOffset { get; } = new("2nd Axis Offset Amplitude", "");
        private GUIContent ContentDpadFirstAxisOffsetAngle { get; } = new("1st Axis Angle Amplitude", "");
        private GUIContent ContentDpadSecondAxisOffsetAngle { get; } = new("2nd Axis Angle Amplitude", "");
        private GUIContent ContentDpadFirstAxisOffset { get; } = new("1st Axis Offset Amplitude", "");
        private GUIContent ContentDpadSecondAxisOffset { get; } = new("2nd Axis Offset Amplitude", "");
