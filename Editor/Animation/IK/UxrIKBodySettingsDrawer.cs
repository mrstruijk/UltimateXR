...
namespace UltimateXR.Editor.Animation.IK
{
    ...
    public class UxrIKBodySettingsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var avatar = ((MonoBehaviour) property.serializedObject.targetObject).GetComponent<UxrAvatar>();
        ...
        {
            var controller = property.serializedObject.targetObject as UxrAvatarController;
        ...
        private GUIContent ContentLockBodyPivot { get; } = new("Lock Body Pivot", "");
        private GUIContent ContentBodyPivotRotationSpeed { get; } = new("Body Pivot Rotation Speed", "");
        private GUIContent ContentHeadFreeRangeBend { get; } = new("Head Free Range Bend", "");
        private GUIContent ContentHeadFreeRangeTorsion { get; } = new("Head Free Range Torsion", "");
        private GUIContent ContentNeckHeadBalance { get; } = new("Neck-Head Balance", "");
        private GUIContent ContentSpineBend { get; } = new("Spine Bend", "");
        private GUIContent ContentSpineTorsion { get; } = new("Spine Torsion", "");
        private GUIContent ContentChestBend { get; } = new("Chest Bend", "");
        private GUIContent ContentChestTorsion { get; } = new("Chest Torsion", "");
        private GUIContent ContentUpperChestBend { get; } = new("Upper Chest Bend", "");
        private GUIContent ContentUpperChestTorsion { get; } = new("Upper Chest Torsion", "");
        private GUIContent ContentNeckBaseHeight { get; } = new("Neck Base Height", "");
        private GUIContent ContentNeckForwardOffset { get; } = new("Neck Forward Offset", "");
        private GUIContent ContentEyesBaseHeight { get; } = new("Eyes Base Height", "");
        private GUIContent ContentEyesForwardOffset { get; } = new("Eyes Forward Offset", "");
