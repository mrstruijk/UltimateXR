...
namespace UltimateXR.Editor.Animation.IK
{
    ...
    public class UxrCcdIKSolverEditor : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            foreach (var link in solverCcd.Links)
            {
                if (link.Bone == null)
                {
                    continue;
                ...
                var normal = link.Bone.TransformDirection(link.RotationAxis1);
                ...
                var angle1Min = link.Axis1HasLimits ? link.Axis1AngleMin : -180.0f;
                var angle1Max = link.Axis1HasLimits ? link.Axis1AngleMax : 180.0f;
                ...
                {
                    var angle2Min = link.Axis2HasLimits ? link.Axis2AngleMin : -180.0f;
                    var angle2Max = link.Axis2HasLimits ? link.Axis2AngleMax : 180.0f;
