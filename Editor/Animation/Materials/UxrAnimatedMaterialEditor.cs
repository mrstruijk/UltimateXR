...
namespace UltimateXR.Editor.Animation.Materials
{
    ...
    public class UxrAnimatedMaterialEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var animatedMaterial = (UxrAnimatedMaterial) serializedObject.targetObject;
        ...
        private GUIContent ContentAnimateSelf { get; } = new("Animate Self");
        private GUIContent ContentTargetGameObject { get; } = new("Target GameObject");
        private GUIContent ContentMaterialSlot { get; } = new("Material Slot");
        private GUIContent ContentMaterialMode { get; } = new("Material Mode");
        private GUIContent ContentRestoreWhenFinished { get; } = new("Restore When Finished", "Restores the original material when the instance animation finished. Use this for performance since shared materials can save draw calls and render state changes");
        private GUIContent ContentParameterType { get; } = new("Parameter Type");
        private GUIContent ContentParameterName { get; } = new("Parameter Name");
