...
namespace UltimateXR.Editor.Audio
{
    ...
    public class UxrAudioManipulationEditor : UnityEditor.Editor
    {
        ...
        private GUIContent ContentContinuousManipulationAudio { get; } = new("Continuous Manipulation", "");
        private GUIContent ContentAudioLoopClip { get; } = new("Audio Loop Clip", "");
        private GUIContent ContentMinVolume { get; } = new("Min Volume", "");
        private GUIContent ContentMaxVolume { get; } = new("Max Volume", "");
        private GUIContent ContentMinFrequency { get; } = new("Min Frequency", "");
        private GUIContent ContentMaxFrequency { get; } = new("Max Frequency", "");
        private GUIContent ContentMinSpeed { get; } = new("Min Speed", "");
        private GUIContent ContentMaxSpeed { get; } = new("Max Speed", "");
        private GUIContent ContentMinAngularSpeed { get; } = new("Min Angular Speed", "");
        private GUIContent ContentMaxAngularSpeed { get; } = new("Max Angular Speed", "");
        private GUIContent ContentUseExternalRigidbody { get; } = new("Use External Rigidbody", "");
        private GUIContent ContentExternalRigidbody { get; } = new("External Rigidbody", "");
