...
namespace UltimateXR.Editor.Locomotion
{
    ...
    public class UxrTeleportLocomotionEditor : UxrTeleportLocomotionBaseEditor
    {
        ...
        private GUIContent ContentArcSegments { get; } = new("Arc Segments", "The number of subdivisions to use to render the arc");
        private GUIContent ContentArcWidth { get; } = new("Arc Width", "The width of the arc");
        private GUIContent ContentArcScrollSpeedValid { get; } = new("Arc Scroll Speed (Valid Target)", "The arc material scroll speed when the destination is valid");
        private GUIContent ContentArcScrollSpeedInvalid { get; } = new("Arc Scroll Speed (Invalid Target)", "The arc material scroll speed when the destination is invalid");
        private GUIContent ContentArcMaterialValid { get; } = new("Arc Material (Valid Target)", "The arc material used when the destination is valid");
        private GUIContent ContentArcMaterialInvalid { get; } = new("Arc Material (Invalid Target)", "The arc material used when the destination is invalid");
        private GUIContent ContentArcFadeLength { get; } = new("Arc Fade Length", "The fade length used when the arc exits the hand or collides with a target to hide intersections");
        private GUIContent ContentRaycastStepsQuality { get; } = new("Blocking Raycast Steps Quality", "How many subdivisions along the arc to perform to raycasts against the scenario");
